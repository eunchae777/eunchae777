...
UI/UX 이해를 바탕으로 **디자인 의도를 정확히 구현하는 퍼블리싱**을 지향합니다.  
HTML, CSS, JavaScript 기반의 **반응형 웹·접근성·레이아웃 안정성**에 강점이 있으며,  
웹 서비스 구현 과정에서 **AI·데이터 기술을 확장 역량으로 활용**하고 있습니다.
...
**UI/UX 웹디자인 · 웹퍼블리셔 · 프론트엔드 전문가 과정 수료**  
📅 2025.02 ~ 2025.08  

- HTML5 / CSS3 / JavaScript 웹 퍼블리싱  
- 반응형 웹 · 웹 접근성 · UI/UX 설계  
- Figma 기반 디자인 → 퍼블리싱 협업 경험  
...
- 머신러닝 · 딥러닝 모델링  
- LLM 활용 서비스 구현 (RAG, API 연동)

---

<p align="center">
  <a href="https://github.com/eunchae777/ai" style="text-decoration:none;">
    <img src="https://img.shields.io/badge/📒%20학습일지-222222?style=for-the-badge&logo=github&logoColor=white">
  </a>
  &nbsp;
